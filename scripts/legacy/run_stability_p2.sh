#!/bin/bash
# 只跑 Test 2 和 Test 3（Test 1 已完成 2/3）
...
echo "============================================"
echo "STABILITY TESTS (Part 2)"
echo "============================================"

# ═══════════════════════════════════════════
# Test 1 Round 3 (retry)
# ═══════════════════════════════════════════
echo ""
echo "=== Test 1: Round 3 (retry) ==="
warmup
echo "  Round 3/3..."
RESP=$(orch "Round 3: Design a simple API for user management")
STATE=$(get_state "$RESP")
check "round_3" "[ '$STATE' = 'DONE' ]" "state=$STATE"
