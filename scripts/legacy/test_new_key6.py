#!/usr/bin/env python3
"""快速测试 — 使用完整 OpenRouter key"""
import json, subprocess, os

# 用 curl 从 D1 获取完整 key（用 json 格式避免截断）
...
print("Key length: " + str(len(or_key)))
print("Key prefix: " + or_key[:30])

# 测试 owl-alpha
auth_header = "Authorization: Bearer *** + or_key
