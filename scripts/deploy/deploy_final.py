...
result = subprocess.run(['wrangler', '--version'], capture_output=True, text=True, timeout=10, env=env)
print("Wrangler version:", result.stdout.strip())

# Deploy the .ts file directly
